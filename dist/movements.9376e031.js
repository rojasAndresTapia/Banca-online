...
var getMovements = function getMovements(accountId) {
  return _axios.default.get("".concat(url)).then(function (response) {
    var movementList = response.data.filter(function (res) {
...
exports.mapMovementListFromApiToVm = void 0;

var mapMovementListFromApiToVm = function mapMovementListFromApiToVm(movementList) {
  return movementList.map(function (movement) {
    return mapMovementFromApiToVm(movement);
  });
};

exports.mapMovementListFromApiToVm = mapMovementListFromApiToVm;
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"common/api/getAccount.api.js":[function(require,module,exports) {
"use strict";
...
var _getAccount = require("../../common/api/getAccount.api");
...
var account = {};
(0, _movements.getMovements)(params.id).then(function (movementList) {
  var movementListViewModel = (0, _movements3.mapMovementListFromApiToVm)(movementList);
  (0, _movements2.addMovementRows)(movementListViewModel);
});
(0, _getAccount.getAccount)(params.id).then(function (apiAccount) {
  account = (0, _account.mapAccountFromApitoViewModel)(apiAccount);
  (0, _helpers.onSetValues)(account);
});
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js","../../core/router":"core/router/index.js","../../common/helpers":"common/helpers/index.js","../../common/api/getAccount.api":"common/api/getAccount.api.js","../account/account.mappers":"pages/account/account.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
