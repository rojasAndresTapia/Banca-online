...
},{}],"pages/transfer/transfers.validations.js":[function(require,module,exports) {
"use strict";
...
exports.insertTransfer = exports.getTransfers = void 0;
...
var getTransfers = function getTransfers(accountId) {
  return _axios.default.get("".concat(url)).then(function (response) {
    var transferList = response.data.filter(function (res) {
      return res.accountId === accountId;
    });
    return transferList;
  });
};
...
},{"axios":"../node_modules/axios/index.js"}],"pages/transfer/transfer.mapper.js":[function(require,module,exports) {
"use strict";
...
},{}],"pages/transfer/transfers.js":[function(require,module,exports) {
"use strict";
...
var _transfers = require("./transfers.validations");
...
var _transfer3 = require("./transfer.mapper");
...
(0, _transfer2.getTransfers)(params.id).then(function (list) {
  var res = list;
});
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfers.formValidation.validateField('iban', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfers.formValidation.validateField('name', transfer.name).then(function (result) {
    (0, _helpers.onSetError)('name', result);
  });
});
(0, _helpers.onUpdateField)('amount', function (event) {
  var value = parseFloat(Math.abs(event.target.value)).toFixed(2);
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    amount: value
  });
  console.log('value', value);

  _transfers.formValidation.validateField('amount', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfers.formValidation.validateField('concept', transfer.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _transfers.formValidation.validateField('notes', transfer.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('day', function (event) {
  ...
  _transfers.formValidation.validateField('day', transfer.day).then(function (result) {
...
(0, _helpers.onUpdateField)('month', function (event) {
  ...
  _transfers.formValidation.validateField('month', transfer.month).then(function (result) {
...
(0, _helpers.onUpdateField)('year', function (event) {
  ...
  _transfers.formValidation.validateField('year', transfer.year).then(function (result) {
    (0, _helpers.onSetError)('year', result);
  });
});

var transferDateToDate = function transferDateToDate() {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfers.formValidation.validateField('email', transfer.email).then(function (result) {
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  ...
  _transfers.formValidation.validateForm(transfer).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);

    if (result.succeeded) {
      (0, _transfer2.insertTransfer)((0, _transfer3.mapTransferFromVmtoApi)(transfer));
    }
  });
});
},{"./transfer.helpers":"pages/transfer/transfer.helpers.js","../../common/helpers":"common/helpers/index.js","./transfers.validations":"pages/transfer/transfers.validations.js","../../common/api/account-list.api":"common/api/account-list.api.js","../../core/router":"core/router/index.js","./transfer.api":"pages/transfer/transfer.api.js","./transfer.mapper":"pages/transfer/transfer.mapper.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/transfer/transfers.js"], null)
//# sourceMappingURL=/transfers.52477be1.js.map