...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"common/api/getAccount.api.js":[function(require,module,exports) {
"use strict";
...
var updateAccount = function updateAccount(account) {
  return _axios.default.put("".concat(url, "/").concat(account.id)).then(function (response) {
    return response.data;
  });
};
